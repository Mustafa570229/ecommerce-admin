...
export default function Nav({show}) {
  ...
  return (
    <aside className={(show?'left-0':'-left-full')+" top-0 text-white p-4 fixed w-full bg-blue-700 h-full md:static md:w-auto transition-all"}>
      ...
      <nav className="flex flex-col gap-2">
        ...
        <button onClick={logout} className='flex gap-1 p-1 text-red-900 font-semibold'>
